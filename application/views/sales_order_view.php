...
<head>
    ...
    <style>
        ...
        #tbl_for_printing input{
            border: 0px solid #90A4AE!important;
            width: 100%!important;
        }
        #tbl_for_printing input.fp_qty{
...
<div class="panel-body">
    ...
    <div class="row" style="padding: 1%;margin-top: 0px;padding-top:0px;">
        ...
        <form id="frm_sales_order_printing" role="form" class="form-horizontal">
            <table id="tbl_for_printing" class="table table-striped"  cellspacing="0" width="100%" style="font-font:tahoma;">
                <tr>
                    <td rowspan="2" width="10%" style="margin-left: 5px!important;padding-left: 5px!important;"><strong>Label (material) <br><br> Color for print</strong></td>
                    <td width="10%"><center><strong>Opp Adhesive Label </strong></center></td>
                    <td width="10%"><center><strong>Adhesive Paper</strong></center></td>
                    <td width="10%"><center><strong>Cardboard210GSM</strong></center></td>
                    <td width="10%"><center><strong>PAPER+CPP</strong></center></td>
                    <td width="10%"><center><strong>PET+CPP</strong></center></td>
                    <td width="10%"><center><strong>MATERIALS FOR SLIPPER</strong></center></td>
                    <td width="10%"><center><strong>Other</strong></center></td>
                </tr>
                <tr>
                    <td><input type="text" class="form-control fp" name="cfp1_opp_adhesive"></td>
                    <td><input type="text" class="form-control fp" name="cfp1_adhesive"></td>
                    <td><input type="text" class="form-control fp" name="cfp1_cardboard"></td>
                    <td><input type="text" class="form-control fp" name="cfp1_paper_cpp"></td>
                    <td><input type="text" class="form-control fp" name="cfp1_pet_cpp"></td>
                    <td><input type="text" class="form-control fp" name="cfp1_mat_slipper"></td>
                    <td><input type="text" class="form-control fp" name="cfp1_other"></td>
                </tr>
                <tr>
                    <td style="margin-left: 5px!important;padding-left: 5px!important;"><strong>Description</strong></td>
                    <td><input type="text" class="form-control fp" name="desc_opp_adhesive"></td>
                    <td><input type="text" class="form-control fp" name="desc_adhesive"></td>
                    <td><input type="text" class="form-control fp" name="desc_cardboard"></td>
                    <td><input type="text" class="form-control fp" name="desc_paper_cpp"></td>
                    <td><input type="text" class="form-control fp" name="desc_pet_cpp"></td>
                    <td><input type="text" class="form-control fp" name="desc_mat_slipper"></td>
                    <td><input type="text" class="form-control fp" name="desc_other"></td>
                </tr>
                <tr>
                    <td style="margin-left: 5px!important;padding-left: 5px!important;"><strong>Quantity</strong></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty1_opp_adhesive"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty1_adhesive"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty1_cardboard"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty1_paper_cpp"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty1_pet_cpp"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty1_mat_slipper"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty1_other"></td>
                </tr>
                <tr>
                    <td style="margin-left: 5px!important;padding-left: 5px!important;border-top: 3px solid #9a9999!important;"><strong>Direct Print</strong></td>
                    <td style="border-top: 3px solid gray!important;"><input type="text" class="form-control fp" name="dp_opp_adhesive"></td>
                    <td style="border-top: 3px solid gray!important;"><input type="text" class="form-control fp" name="dp_adhesive"></td>
                    <td style="border-top: 3px solid gray!important;"><input type="text" class="form-control fp" name="dp_cardboard"></td>
                    <td style="border-top: 3px solid gray!important;"><input type="text" class="form-control fp" name="dp_paper_cpp"></td>
                    <td style="border-top: 3px solid gray!important;"><input type="text" class="form-control fp" name="dp_pet_cpp"></td>
                    <td style="border-top: 3px solid gray!important;"><input type="text" class="form-control fp" name="dp_mat_slipper"></td>
                    <td style="border-top: 3px solid gray!important;"><input type="text" class="form-control fp" name="dp_other"></td>
                </tr>    
                <tr>
                    <td style="margin-left: 5px!important;padding-left: 5px!important;"><strong>Colors for print</strong></td>
                    <td><input type="text" class="form-control fp" name="cfp2_opp_adhesive"></td>
                    <td><input type="text" class="form-control fp" name="cfp2_adhesive"></td>
                    <td><input type="text" class="form-control fp" name="cfp2_cardboard"></td>
                    <td><input type="text" class="form-control fp" name="cfp2_paper_cpp"></td>
                    <td><input type="text" class="form-control fp" name="cfp2_pet_cpp"></td>
                    <td><input type="text" class="form-control fp" name="cfp2_mat_slipper"></td>
                    <td><input type="text" class="form-control fp" name="cfp2_other"></td>
                </tr>   
                <tr>
                    <td style="margin-left: 5px!important;padding-left: 5px!important;"><strong>Model/ Ml</strong></td>
                    <td><input type="text" class="form-control fp" name="ml_opp_adhesive"></td>
                    <td><input type="text" class="form-control fp" name="ml_adhesive"></td>
                    <td><input type="text" class="form-control fp" name="ml_cardboard"></td>
                    <td><input type="text" class="form-control fp" name="ml_paper_cpp"></td>
                    <td><input type="text" class="form-control fp" name="ml_pet_cpp"></td>
                    <td><input type="text" class="form-control fp" name="ml_mat_slipper"></td>
                    <td><input type="text" class="form-control fp" name="ml_other"></td>
                </tr>  
                <tr>
                    <td style="margin-left: 5px!important;padding-left: 5px!important;"><strong>Quantity</strong></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty2_opp_adhesive"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty2_adhesive"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty2_cardboard"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty2_paper_cpp"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty2_pet_cpp"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty2_mat_slipper"></td>
                    <td><input type="text" class="numeric fp_qty form-control" name="qty2_other"></td>
                </tr>   
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            Production Time :<br />
            <div class="input-group">
                <input type="text" id="production_time" name="production_time" class="form-control" placeholder="Production Time" data-error-msg="Please set the date this items are ordered!" required>
                    <span class="input-group-addon">
                         <i class="fa fa-calendar"></i>
                    </span>
            </div>
        ...
        <div class="col-sm-4">
            Estimated Day :<br />
            <div class="input-group">
                <input type="text" id="estimated_date" name="estimated_date" class="date-picker form-control" value="<?php echo date("m/d/Y"); ?>" placeholder="Estimated Day">
                    <span class="input-group-addon">
                         <i class="fa fa-calendar"></i>
                    </span>
            </div>
                ...
                <div class="table-responsive">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><strong>Total After Discount:</strong></td>
                            ...
                            <tr>
                                <td align="right"><strong>Commission</strong></td>
                                <td >
                                    <input id="commission" name="commission" type="text" class="numeric form-control" value="0.00" />
                                </td>
                                <td width="12%"><strong>Down Payment: </strong> </td>
                                <td width="10%"><input type="text" class="numeric form-control" id="down_payment" name="down_payment" value="0.00" /></td>
                                <td align="right"><strong>Tax:</strong></td>
                                <td align="right" colspan="1" id="td_tax" color="red">0.00</td>
                                <td style="text-align: right;"><strong><i class="glyph-icon icon-star"></i> Total After Tax :</strong></td>
...
$(document).ready(function(){
            ...
            "columns": [
                ...
                { targets:[5],data: "order_status" },
                {
                    ...
                    render: function (data, type, full, meta){
                        var btn_edit='<button class="btn btn-primary btn-sm <?php echo (in_array('17-1',$this->session->user_rights)?'':'hidden'); ?>" name="edit_info"  style="margin-left:0px;" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i> </button>';
                        var btn_trash='<button class="btn btn-red btn-sm <?php echo (in_array('17-2',$this->session->user_rights)?'':'hidden'); ?>" name="remove_info" style="margin-right:0px;" data-toggle="tooltip" data-placement="top" title="Move to trash"><i class="fa fa-trash-o"></i> </button>';
    ...
    var bindEventHandlers=(function(){
        ...
        $('#btn_new').click(function(){
            ...
            clearFields($('#frm_sales_order, #frm_sales_order_printing'));
        ...
        $('#tbl_sales_order tbody').on('click','button[name="edit_info"]',function(){
            ...
            $('textarea,input:not(.fp_qty)').each(function(){
                var _elem=$(this);
            ...
            if (data.estimated_date == "0000-00-00"){
                $('#estimated_date').val('');
            }else{
                $('#estimated_date').val(data.estimated_date);
            }
        ...
        $('#btn_save').click(function(){
            if(validateRequiredFields($('#frm_sales_order,#frm_sales_order_printing'))){
                if(_txnMode=="new"){
    ...
    var newRowItem=function(d){
        ...
        '<td colspan="2">'+d.product_desc+'<input type="text" style="display:none;" class="form-control" name="is_parent[]" value="'+d.is_parent+'"></td>'+
    ...
    var reComputeTotal=function(){
        ...
        var commission = parseFloat(accounting.unformat($('#commission').val())); 
