                                               ...
                                               <form id="frm_company" role="form" class="form-horizontal row-border">
                                                   ...
                                                   <div class="form-group">
                                                       <label class="col-md-3 control-label">  
                                                            <span class="fa fa-cog" style="font-size: 20pt;vertical-align: middle!important;"></span> 
                                                            <span style="font-size: 10pt;">Template Header :</span> 
                                                            <br />
                                                            <input type="checkbox" name="is_template_header" id="template_header" 
                                                            <?php if ($company->is_template_header > 0){ echo "checked"; }?>
                                                            style="width: 20px;height: 20px;">
                                                            <label for="template_header" style="position: relative;margin-top: -10px!important;">Use Header</label>
                                                        </label>
                                                       <div class="col-md-7">
                                                           <div class="input-group">
                                                               <div class="" style="border:1px solid black;height: 150px;width: 100%;vertical-align: middle;">

                                                                   <div id="div_img_company_header" style="position:relative;">
                                                                       <img name="img_company_header" src="<?php echo $company->header_path; ?>" style="object-fit: fill !important; height: 100%;width: 100%;" />
                                                                       <input type="file" name="file_upload_header[]" class="hidden">
                                                                   </div>

                                                                   <div id="div_img_loader_header" style="display: none;">
                                                                        <img name="img_loader_header" src="assets/img/loader/ajax-loader-sm.gif" style="display: block;margin:40% auto auto auto; " />
                                                                   </div>
                                                               </div>

                                                               <button type="button" id="btn_browse_header" class="btn btn-green "  style="margin-top: 2%;text-transform: capitalize;font-family: Tahoma, Georgia, Serif;">Browse Photo</button>&nbsp;
                                                               <button type="button" id="btn_remove_photo_header"  class="btn btn-red" style="margin-top: 2%;text-transform: capitalize;font-family: Tahoma, Georgia, Serif;">Remove</button>
                                                           </div>
                                                       </div>
                                                   </div>
    ...
    $(document).ready(function(){
        ...
        var bindEventHandlers=(function(){
            ...
            $('#tbl_company_info tbody').on( 'click', 'tr td.details-control', function () {
             ...
             $('#btn_browse_header').click(function(event){
                    event.preventDefault();
                    $('input[name="file_upload_header[]"]').click();
             });
            ...
            $('#btn_remove_photo_header').click(function(event){
                event.preventDefault();
                $('img[name="img_company_header"]').attr('src','');
            });            
            ...
            _company_info.on("select2:select", function (e) {
                ...
                $('input[name="file_upload_header[]"]').change(function(event){
                    var _files=event.target.files;

                    $('#div_img_company_header').hide();
                    $('#div_img_loader_header').show();
                    ...
                    $.ajax({
                        url : 'Company/transaction/upload_header',
                        type : "POST",
                        data : data,
                        cache : false,
                        dataType : 'json',
                        ...
                        success : function(response){
                            //console.log(response);
                            //alert(response.path);
                            $('#div_img_loader_header').hide();
                            $('#div_img_company_header').show();
                            $('img[name="img_company_header"]').attr('src',response.path);
        ...
        var createCompanyInfo=function(){
            ...
            _data.push({name : "header_path" ,value : $('img[name="img_company_header"]').attr('src')});

            if ($('#template_header').is(':checked') == true){
                _data.push({name : "is_template_header", value : 1});
            }else{
                _data.push({name : "is_template_header", value : 0});
            }
