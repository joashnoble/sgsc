                    ...
                    <ul class="acc-menu">
                        ...
                        <li class="<?php echo (in_array('3',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-shopping-cart"></i><span>Sales</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('3-6',$this->session->user_rights)?'':'hidden'); ?>"><a href="Issuance_department">Warehouse Issue / Pull Out</a></li>
                                ...
                                <li class="<?php echo (in_array('3-5',$this->session->user_rights)?'':'hidden'); ?>"><a href="Dispatching">Dispatching</a></li>
...
<!--                         <li class="<?php echo (in_array('15',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-file"></i><span>Bir Forms</span></a>
                        ...
                        <li class="<?php echo (in_array('8',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-pie-chart"></i><span>Sales &amp; Purchasing</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('8-2',$this->session->user_rights)?'':'hidden'); ?>"><a href="Credit_ceiling_report">Credit Ceiling Report</a></li>
                                <li class="<?php echo (in_array('8-3',$this->session->user_rights)?'':'hidden'); ?>"><a href="Salesperson_commission">Salesperson Commission Report</a></li>
