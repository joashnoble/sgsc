...
<div>
    ...
    <center>
        <table width="95%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11" >
            ...
            <tfoot>
            <tr>
                <td align="left" colspan="2" style="border-left: 1px solid gray;padding: 6px;border-bottom: 1px solid gray;"><b>Prepared by:</b></td>
            ...
            <tr>
                <td colspan="2" style="height: 15px;padding: 6px;border-left: 1px solid gray;border-bottom: 1px solid gray;"><b>Confirmed by: </b></td>
            ...
            <tr>
                <td colspan="2" style="height: 15px;padding: 6px;border-bottom: 1px solid gray;border-left: 1px solid gray;"><b>Check by:</b></td>
            ...
            <tr>
                <td colspan="2" style="text-align: left;height: 15px;padding: 6px;border-left: 1px solid gray;border-bottom: 1px solid gray;"><b>Certified by:</b></td>
