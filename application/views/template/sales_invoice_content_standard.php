...
<!--             <tr>
            ...
            <tr>
                <td colspan="3" class="left bottom" style="height: 30px;padding: 6px;"></td>
                <td colspan="2" class="left bottom" style="text-align: left;height: 30px;padding: 6px;">Down Payment:</td>
                <td class="bottom right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($sales_info->down_payment,2); ?></td>
            </tr>
            <tr>
