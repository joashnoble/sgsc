...
<html>
<head>
	<title>Customer Sales Order Report (Summary)</title>
	<style>
		body {
...
<body>
    ...
    <div class="">
        <h3><strong>SALES ORDER REPORT PER CUSTOMER (SUMMARY)</strong></h3>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="2">
    	...
    	<?php foreach ($sales_summaries as $sales_summary) { ?>
    		<tr>
    			...
    			<td width="50%" align="right"><?php echo number_format($sales_summary->customer_total,2); ?></td>
    		</tr>
            <?php $sum+=$sales_summary->customer_total; ?>
    	<?php } ?>
        <tr>
