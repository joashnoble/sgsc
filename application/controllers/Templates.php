        ...
        switch($layout){
            ...
            case 'issuance-department': //delivery invoice
                ...
                $info=$m_issuance->get_list(
                    ...
                    array(
                        ...
                        array('customers','customers.customer_id=issuance_department_info.customer_id','left')
                    )
                );
            ...
            $m_company_info=$this->Company_model;
                ...
                $info=$m_sales_order->get_list(
                    $filter_value,
                    'sales_order.*,sales_order_printing.*,departments.department_name,customers.customer_name,customers.contact_no',
                    array(
